...
public class Activity3 {
    ...
    public Activity3(String carModel, String carName, double carPrice) {
    ...
    public static void main(String[] args) {
        ...
        if (averagePrice>=100000){
            System.out.println("It is expensive as heck");
        } else if(averagePrice>49999 && averagePrice<100000){
            System.err.println("It is normal Market Price");
        } else {
            System.err.println("It is CHEAPPPPPPP");
        }
